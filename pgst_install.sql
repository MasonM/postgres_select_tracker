...
BEGIN
	...
	EXECUTE 'INSERT INTO ' || quote_ident(table_name) || ' SELECT * FROM ' || quote_ident(pgst_suffix_table_name(table_name, 'track'));
	EXECUTE 'DROP TABLE ' || quote_ident(pgst_suffix_table_name(table_name, 'track')) || ' CASCADE';
END;
$$ LANGUAGE plpgsql VOLATILE;
